...
When you have been provided access to the release, once the maven local install script has been run, this branch will allow you to create a basic app which can run on an ARM Linux machine.
